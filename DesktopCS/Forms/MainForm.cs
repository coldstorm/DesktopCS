...
namespace DesktopCS.Forms
{
    public partial class MainForm : Form
    {
        ...
        private void AddLine(int tabIndex, string line)
        {
            ...
            string currRTF;
            if (!String.IsNullOrEmpty((TabList.TabPages[tabIndex].Controls["TextBox"] as RichTextBox).Rtf))
            {
                currRTF = (TabList.TabPages[tabIndex].Controls["TextBox"] as RichTextBox).Rtf;
            }
            ...
            (TabList.TabPages[tabIndex].Controls["TextBox"] as RichTextBox).Rtf = newRTF;
        }
